---
title: "后端开发常用框架文档及中文翻译"
id: csdn96101522
---

[https://www.docs4dev.com](https://www.docs4dev.com)

包含 Spring 系列文档（Spring, Spring Boot, Spring Cloud, Spring Security, Spring Session），大数据（Apache Hive, HBase, Apache Flume），日志（Log4j2, Logback），Http Server（NGINX，Apache），Python，数据库（OpenTSDB，MySQL，PostgreSQL）等最新官方文档以及对应的中文翻译。
