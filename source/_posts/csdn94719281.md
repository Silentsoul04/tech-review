...
[https://gitee.com/apachecn/org-tasks/raw/master/docs/img/20190705-1.png](https://gitee.com/apachecn/org-tasks/raw/master/docs/img/20190705-1.png)

[https://gitee.com/apachecn/org-tasks/raw/master/docs/img/20190705-2.png](https://gitee.com/apachecn/org-tasks/raw/master/docs/img/20190705-2.png)
...
| 章节 | 贡献者 | 进度 |
| --- | --- | --- |
| [1.关于本书（ES2019 版）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/2.md) | [@YouWillBe](https://github.com/YouWillBe) | 100% |
| [2.常见问题：本书](https://github.com/apachecn/impatient-js-zh/tree/master/docs/3.md) | [@huangzijian888](https://github.com/huangzijian888) | 100% |
...
| [5.概览](https://github.com/apachecn/impatient-js-zh/tree/master/docs/7.md) | [@kj415j45](https://github.com/kj415j45) | 100% |
| [6.语法](https://github.com/apachecn/impatient-js-zh/tree/master/docs/8.md) | [@lq920320](https://github.com/lq920320) | 100% |
| [7.在控制台上打印信息（`console.*`）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/9.md) | [@lq920320](https://github.com/lq920320) | 100% |
| [8.断言 API](https://github.com/apachecn/impatient-js-zh/tree/master/docs/10.md) | [@lq920320](https://github.com/lq920320) | 100% |
| [9.测验和练习入门](https://github.com/apachecn/impatient-js-zh/tree/master/docs/11.md) | [@so-hard](https://github.com/so-hard) | 100% |
| [10.变量和赋值](https://github.com/apachecn/impatient-js-zh/tree/master/docs/13.md) | [@so-hard](https://github.com/so-hard) | 100% |
| [11.值](https://github.com/apachecn/impatient-js-zh/tree/master/docs/14.md) | [@lq920320](https://github.com/lq920320) | 100% |
| [12.运算符](https://github.com/apachecn/impatient-js-zh/tree/master/docs/15.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
| [13.非值`undefined`和`null`](https://github.com/apachecn/impatient-js-zh/tree/master/docs/17.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
| [14.布尔值](https://github.com/apachecn/impatient-js-zh/tree/master/docs/18.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
| [15.数字](https://github.com/apachecn/impatient-js-zh/tree/master/docs/19.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
| [16\. `Math`](https://github.com/apachecn/impatient-js-zh/tree/master/docs/20.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
| [17\. Unicode - 简要介绍（高级）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/21.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
| [18.字符串](https://github.com/apachecn/impatient-js-zh/tree/master/docs/22.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
| [19.使用模板字面值和标记模板](https://github.com/apachecn/impatient-js-zh/tree/master/docs/23.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
| [20.符号](https://github.com/apachecn/impatient-js-zh/tree/master/docs/24.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
| [21.控制流语句](https://github.com/apachecn/impatient-js-zh/tree/master/docs/26.md) | [@wizardforcel](https://github.com/wizardforcel) | 100% |
...
| [26.原型链和类](https://github.com/apachecn/impatient-js-zh/tree/master/docs/32.md) | [@lq920320](https://github.com/lq920320) | 100% |
| [27.同步迭代](https://github.com/apachecn/impatient-js-zh/tree/master/docs/34.md) | [@lq920320](https://github.com/lq920320) |  |
| [28.数组（`Array`）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/35.md) | [@52admln](https://github.com/52admln) | 100% |
| [29.类型化数组：处理二进制数据（高级）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/36.md) |  |  |
| [30.映射（`Map`）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/37.md) | [@so-hard](https://github.com/so-hard) |  |
...
| [34.解构](https://github.com/apachecn/impatient-js-zh/tree/master/docs/41.md) | [@Kavelaa](https://github.com/Kavelaa) | 100% |
| [35.同步生成器（高级）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/42.md) |  |  |
| [36\. JavaScript 中的异步编程](https://github.com/apachecn/impatient-js-zh/tree/master/docs/44.md) | [@Kavelaa](https://github.com/Kavelaa) | 100% |
| [37.异步编程的 Promise](https://github.com/apachecn/impatient-js-zh/tree/master/docs/45.md) | [@iChrisJ](https://github.com/iChrisJ) | 100% |
| [38.异步函数](https://github.com/apachecn/impatient-js-zh/tree/master/docs/46.md) | [@iChrisJ](https://github.com/iChrisJ) | 100% |
| [39.正则表达式（`RegExp`）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/48.md) | [@iChrisJ](https://github.com/iChrisJ) | 100% |
| [40.日期（`Date`）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/49.md) | [@facebesidewyj](https://github.com/facebesidewyj) | 100% |
| [41.创建和解析 JSON（`JSON`）](https://github.com/apachecn/impatient-js-zh/tree/master/docs/50.md) | [@xdyushenli](https://github.com/xdyushenli) |  |
...
整体进度：[https://github.com/apachecn/tensorflow-doc-zh/issues/3](https://github.com/apachecn/tensorflow-doc-zh/issues/3)

项目仓库：[https://github.com/apachecn/tensorflow-doc-zh](https://github.com/apachecn/tensorflow-doc-zh)
...
| --- | --- | --- | --- | --- |
| 快速入门 | - | - | - | - |
| [开始使用TensorFlow 2.0](tutorials/quickstart/getting_started.md) | @jiangzhonglian | 100% | - | - |
|  | - | - | - | - |
|  | - | - | - | - |
|  | - | - | - | - |
|  | - | - | - | - |
...
|  | - | - | - | - |
| 文本和序列 | - | - | - | - |
| [Word Embeddings 简介](tutorials/text/word_embeddings.md) | @jiangzhonglian | 100% | - | - |
|  | - | - | - | - |
|  | - | - | - | - |
| Estimators | - | - | - | - |
|  | - | - | - | - |
...
*   合作 or 侵权，请联系 apachecn@163.com | 请抄送一份到 wizard.z@foxmail.com
    ![在这里插入图片描述](../img/ce074fbfd514acf5d451b70d4295282b.png)

## 赞助我们

![在这里插入图片描述](../img/9b93bce60a2a68700da9b41f0041431c.png)