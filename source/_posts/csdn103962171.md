---
title: 布客·ApacheCN 翻译/校对/笔记整理活动进度公告 2020.1
id: csdn103962171
---
...
| [第二章 解释性](https://github.com/apachecn/interpretable-ml-book-zh/blob/master/docs/2.md) | @utopfish |  |
| [第三章 数据集](https://github.com/apachecn/interpretable-ml-book-zh/blob/master/docs/3.md) | @GeneralLi95 | 完成 |
| [第四章 解释模型](https://github.com/apachecn/interpretable-ml-book-zh/blob/master/docs/4.md) | @leehindong |  |
...
| [RegionServer Sizing Rules of Thumb](https://github.com/apachecn/hbase-doc-zh/blob/master/docs/7.md) | @ruibababa | 100% |
...
| [ZooKeeper](https://github.com/apachecn/hbase-doc-zh/blob/master/docs/28.md) | @ruibababa | 100% |
...
| 中文教程 | - | - |
| 入门 | - | - |
| [PyTorch 深度学习: 60 分钟极速入门](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/deep_learning_60min_blitz.md) | @FoxerLee | 100% |
| [数据加载和处理教程](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/data_loading_tutorial.md) | @yangkae | 100% |
| [用例子学习 PyTorch](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/pytorch_with_examples.md) | @yangkae | 100% |
| [迁移学习教程](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/transfer_learning_tutorial.md) | @DrDavidS | 100% |
| [部署与TorchScript一个Seq2Seq模型](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/deploy_seq2seq_hybrid_frontend_tutorial.md) | @FoxerLee | 100% |
| [可视化模型，数据，和与训练TensorBoard](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/tensorboard_tutorial.md) | @jiangzhonglian | 100% |
| [保存和加载模型](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/saving_loading_models.md) | @jiangzhonglian | 100% |
| [torch.nn 到底是什么？](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/nn_tutorial.md) | @DrDavidS | 100% |
| 图片 | - | - |
| [TorchVision 对象检测微调教程](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/torchvision_tutorial.md) | @jiangzhonglian | 100% |
| [微调 TorchVision 模型](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/finetuning_torchvision_models_tutorial.md) | @jiangzhonglian | 100% |
| [空间变压器网络教程](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/spatial_transformer_tutorial.md) | @jiangzhonglian | 100% |
| [使用PyTorch进行神经网络传递](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/advanced/neural_style_tutorial.md) | @jiangzhonglian | 100% |
| [对抗性示例生成](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/fgsm_tutorial.md) | @jiangzhonglian | 100% |
| [DCGAN教程](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/dcgan_faces_tutorial.md) | @jiangzhonglian | 100% |
| 音频 | - | - |
...
| [NLP From Scratch: 生成名称与字符级RNN](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/char_rnn_generation_tutorial.md) | @HelWireless | 100% |
| [NLP From Scratch: 基于注意力机制的 seq2seq 神经网络翻译](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/seq2seq_translation_tutorial.md) | @DrDavidS | 100% |
...
| [序列对序列建模nn.Transformer和TorchText](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/transformer_tutorial.md) | @dabney777 | 100% |
| [强化学习（DQN）教程](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/reinforcement_q_learning.md) | @wutongzhang | 100% |
| 在生产部署PyTorch模型 | - | - |
| [通过带有Flask的REST API在Python中部署PyTorch](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/flask_rest_api_tutorial.md) | @pkwangwanjun |  |
| [介绍TorchScript](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/Intro_to_TorchScript_tutorial.md) | @HelWireless | 100% |
| [在C ++中加载TorchScript模型](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/advanced/cpp_export.md) |  |  |
| [（可选）将模型从PyTorch导出到ONNX并使用ONNX Runtime运行](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/advanced/super_resolution_with_onnxruntime.md) |  |  |
| 并行和分布式训练 | - | - |
| [模型并行化最佳实践](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/model_parallel_tutorial.md) | @sherlockbear | 100% |
| [分布式数据并行(DDP)入门](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/ddp_tutorial.md) | @sherlockbear | 100% |
| [PyTorch编写分布式应用](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/intermediate/dist_tuto.md) |  |  |
| [（高级）PyTorch 1.0分布式训练与Amazon AWS](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/beginner/aws_distributed_training_tutorial.md) |  |  |
| 扩展PyTorch | - | - |
| [使用自定义 C++ 扩展算TorchScript](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/advanced/torch_script_custom_ops.md) | @FoxerLee |  |
| [用 numpy 和 scipy 创建扩展](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/advanced/numpy_extensions_tutorial.md) | @FoxerLee | 100% |
| [自定义 C++ 和CUDA扩展](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/advanced/cpp_extension.md) | @FoxerLee | 100% |
| PyTorch在其他语言 | - | - |
...
| [广播语义](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/notes/broadcasting.md) | @AlexJakin | 100% |
| [CPU线程和TorchScript推理](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/notes/cpu_threading_torchscript_inference.md) | @AlexJakin |  |
| [CUDA语义](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/notes/cuda.md) | @AlexJakin | 100% |
...
| [PyTorch 维护者](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/community/persons_of_interest.md) | - | 100% |
| 封装参考文献 | - | - |
| [torch](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/torch.md) | @张假飞 @飞龙 | 100% |
...
| [torch.utils.data](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/data.md) | @shuziP | 100% |
...
| [torch.utils.tensorboard](https://github.com/apachecn/pytorch-doc-zh/blob/master/docs/1.2/tensorboard.md) | @shuziP | 100% |
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-yxKGtBkr-1578909683534)(http://home.apachecn.org/img/about/ibooker_zsxq_qr_l.jpg)]

## **赞助我们**

[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-lOQwg7hS-1578909683535)(http://home.apachecn.org/img/about/zfb_wx.png)]