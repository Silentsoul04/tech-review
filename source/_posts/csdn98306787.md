...
![](../img/7e568cca36d58731a40794b5ee9898da.png)

![](../img/5dde238be302a2569823e592f6b31160.png)

![](../img/07c105262b213231964b39ef4fc7e768.png)

认领须知：

1.  请私聊片刻（529815144）、咸鱼（1034616238）、或飞龙（562826179）来认领任务，我们会把你拉进合伙人群。
2.  [**现有**翻译项目](http://t.cn/AijId2zY)可以直接在 ISSUE 中认领，翻译/校对三个文档就可以申请当负责人。
3.  如果你的想法没有列出，同样欢迎私聊我们。
...
| [基于GrabCut算法的交互式前景提取](https://github.com/apachecn/opencv-doc-zh/blob/master/docs/4.0.0/4.16.md) |  |  |
| 5\. 特征检测和描述 | - |  |
...
| [5.7 简介（二进制鲁棒独立基本特征）](https://github.com/apachecn/opencv-doc-zh/blob/master/docs/4.0.0/5.7.md) | @lyrich |  |
| [5.8 ORB（定向快速和快速旋转）](https://github.com/apachecn/opencv-doc-zh/blob/master/docs/4.0.0/5.8.md) | @lyrich |  |
| [5.9 特征匹配](https://github.com/apachecn/opencv-doc-zh/blob/master/docs/4.0.0/5.9.md) | @lyrich |  |
| [5.10 特征匹配+ Homography查找对象](https://github.com/apachecn/opencv-doc-zh/blob/master/docs/4.0.0/5.10.md) | @lyrich |  |
| 6\. 视频分析 | - |  |
...
![](../img/ff6e733d54d77d50c8678270dd66af10.png)

## 赞助我们

![](../img/f4c01b0bfff951356235edbbdebec213.png)