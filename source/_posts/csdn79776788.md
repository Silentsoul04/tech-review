---
title: "安卓应用安全指南 5.4.1 通过 HTTPS 的通信 示例代码"
id: csdn79776788
---
...
![](../img/d8199df882dba6f08cce8c115d8a5773.png)
...
public abstract class HttpImageSearch extends AsyncTask<String, Void, Object> {
    ...
    protected Object doInBackground(String... params) {
        ...
        String search_url = "http://ajax.googleapis.com/ajax/services/sear../img?v=1.0&q=" +
        s.toString();
...
public abstract class HttpsImageSearch extends AsyncTask<String, Void, Object> {
    ...
    protected Object doInBackground(String... params) {
        ...
        s.deleteCharAt(s.length() - 1);
        String search_url = "https://ajax.googleapis.com/ajax/services/sear../img?v=1.0&q=" +
        s.toString();
        responseArray = getByteArray(search_url);
        if (responseArray == null) {
            return null;
